          ...
          >
            ...
            <div className="relative text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                {currentLang === "en" ? "Ready to improve The Security and Control Room?" : "هل أنت مستعد لتحسين مركزالمراقبة الأمنية الخاص بك؟"}
              </h2>
              <p className="text-white/80 mb-8 max-w-2xl mx-auto">
                {currentLang === "en"
                  ? "Partner with us to build a comprehensive Security and Control Room that drives sustainable growth and innovation."
                  : "شاركنا لبناء استراتيجية لبناءمركز مراقبة وتحكم أمني  يدعم النمو المستدام والابتكار."}
              </p>
              <Link href="/book-demo">
                <motion.button
