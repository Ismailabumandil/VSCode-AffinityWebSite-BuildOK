...
export default function solutionmainpage() {
  ...
  const hero = useMemo(
    () => ({
      ...
      subtitle: {
        en: "Enterprise platforms built to optimize operations, enhance decisions, and accelerate transformation.",
        ar: "منصات مؤسسية لتحسين العمليات، دعم اتخاذ القرار، وتسريع التحول.",
      },
      bullets: [
        { en: "Enterprise-Ready Platforms", ar: "منصات مؤسسية متقدمة" },
        { en: "Scalable & Future-Proof", ar: "قابلة للتوسع ومستقبلية" },
        { en: "Secure API Integrations", ar: "تكاملات API آمنة" },
        { en: "Standards Alignment (ISO, NIST, ITIL)", ar: "التزام بالمعايير (ISO، NIST، ITIL)" },
      ],
    }),
    [],
  )
  ...
  const kpis = useMemo(
    () => [
      { value: 45, suffix: "%", label: { en: "Faster Processes", ar: "تسريع العمليات" } },
      { value: 60, suffix: "%", label: { en: "Less Manual Work", ar: "تقليل العمل اليدوي" } },
      { value: 30, suffix: "%", label: { en: "Better Decisions", ar: "تحسين القرار" } },
      { value: 99.9, suffix: "%", label: { en: "System Reliability", ar: "اعتمادية المنصة" } },
    ],
    [],
  )
  ...
  const solutions = useMemo(
    () => [
      ...
      },
      {
        ...
        desc: {
          en: "Strengthen relationships, automate sales, and elevate customer service.",
          ar: "إدارة العملاء وتحسين المبيعات وخدمة العملاء ضمن منصة متكاملة.",
        },
        points: [
      ...
      },
      {
        ...
        desc: {
          en: "Dynamic workflows, approvals, and process analytics to reduce errors and manual work.",
          ar: "محركات ديناميكية وموافقات وتحليلات لتقليل الأخطاء والجهد اليدوي.",
        },
        points: [
      ...
      },
      {
        ...
        desc: {
          ...
          ar: "تنظيم الدعم وجدولة الفرق ومراقبة SLA ولوحات أداء فورية.",
        },
        points: [
          ...
          { en: "Mobile Apps for Field Teams", ar: "تطبيقات للفرق الميدانية" },
      ...
      },
      {
        ...
        desc: {
          ...
          ar: "أنظمة حسب الطلب—أداء مؤسسي وقابلية توسع.",
        },
        points: [
          { en: "End-to-End Custom Development", ar: "تطوير كامل حسب الطلب" },
          { en: "Industry-Specific Platforms", ar: "منصات متخصصة لكل قطاع" },
          { en: "Legacy Enhancement & Replacement", ar: "تحسين/استبدال الأنظمة القديمة" },
  ...
  const process = useMemo(
    () => [
      ...
      { icon: Workflow, t: { en: "Build", ar: "تنفيذ" }, d: { en: "Develop platforms and AI capabilities.", ar: "تطوير المنصات وقدرات الذكاء." } },
    ...
    () => [
      {
        ...
        a: { en: "Yes—via secure APIs across modules.", ar: "نعم—عبر واجهات API آمنة بين جميع الوحدات." },
      },
      {
        q: { en: "Do you support enterprises and SMEs?", ar: "هل تدعمون المؤسسات والشركات المتوسطة؟" },
        a: { en: "Yes—platforms are scalable for all sizes.", ar: "نعم—حلول قابلة للتوسع لجميع الأحجام." },
      },
      {
        q: { en: "Which standards do you follow?", ar: "ما المعايير التي تلتزمون بها؟" },
        a: { en: "We align with ISO, NIST, ITIL where applicable.", ar: "نلتزم بـ ISO و NIST و ITIL حسب الحاجة." },
      },
      {
        q: { en: "Can you build custom solutions?", ar: "هل تقدمون حلول حسب الطلب؟" },
        a: { en: "Absolutely—end-to-end custom development.", ar: "أكيد—تطوير كامل حسب الطلب." },
      },
    ],
    [],
  )
  ...
  return (
    <div className="min-h-screen neon-bg">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="relative p-8 md:p-12">
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8">
                <div className="max-w-2xl">
                  ...
                  <h1 className="mt-4 text-4xl md:text-5xl font-extrabold leading-tight ai-glow" style={{ color: "var(--page-fg)" }}>
            ...
            <style jsx>{`
              ...
              .ai-glow {
                text-shadow: 0 0 18px rgba(34, 211, 238, 0.25), 0 0 30px rgba(168, 85, 247, 0.18);
                animation: glowPulse 2.8s ease-in-out infinite;
              }
              @keyframes glowPulse {
                0%, 100% { letter-spacing: 0px; filter: hue-rotate(0deg); }
                50% { letter-spacing: 0.6px; filter: hue-rotate(10deg); }
              }
            `}</style>
          </div>
        </div>
      ...
      {/* KPI COUNTERS (appear on scroll) */}
      <section className="py-8 px-4">
        <div className="max-w-7xl mx-auto">
          <KPISection language={language as Lang} items={kpis} />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <style jsx>{`
              ...
              .proc-flow {
                background:
                  radial-gradient(120px 120px at 10% 40%, rgba(168, 85, 247, 0.22), transparent 60%),
...
/* ---------------- KPI Section (Neon counters) ---------------- */
function KPISection({
  language,
  items,
}: {
  language: Lang
  items: { value: number; suffix?: string; label: { en: string; ar: string } }[]
}) {
  const isAr = language === "ar"
  ...
  return (
    <div className="grid md:grid-cols-4 gap-4">
      {items.map((k, i) => (
        <KPICard key={i} language={language} value={k.value} suffix={k.suffix || ""} label={isAr ? k.label.ar : k.label.en} />
      ))}
    </div>
  )
}
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: "color-mix(in srgb, var(--card) 18%, transparent)",
        borderColor: "color-mix(in srgb, var(--primary) 18%, transparent)",
        boxShadow: "0 26px 110px color-mix(in srgb, var(--glow-2) 55%, transparent)",
      }}
    >
      {/* neon streak */}
      <div
      ...
      />
      <div
        className="absolute -bottom-16 -left-16 w-64 h-64 rounded-full blur-3xl opacity-35"
        style={{ background: "color-mix(in srgb, var(--secondary) 20%, transparent)" }}
      />

      <div className="relative">
        <div className="text-4xl font-extrabold" style={{ color: "var(--page-fg)" }}>
          {formatted}
          <span className="text-xl font-bold" style={{ color: "var(--secondary)" }}>
            {suffix}
          </span>
        </div>
        <div className="mt-2 text-sm font-semibold" style={{ color: "var(--muted-foreground)" }}>
          {label}
        </div>
      </div>
    </div>
...
function NeuralNetBackdrop() {
  return (
    <svg viewBox="0 0 1200 600" className="w-full h-full">
      ...
      {/* lines */}
      <g stroke="rgba(34,211,238,0.20)" strokeWidth="2">
        {[
          [120, 140, 380, 200],
          [120, 140, 360, 320],
          [220, 330, 520, 210],
      ...
      {/* nodes (بدون SVG animate لتفادي أي مشاكل بيئات) */}
      <g fill="rgba(34,211,238,0.55)">
        {[
          ...
          <circle key={i} cx={p[0]} cy={p[1]} r="7" />
        ))}
      </g>
    </svg>
  )
