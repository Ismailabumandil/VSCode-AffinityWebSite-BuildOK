...
export function VideoTestimonials({ currentTheme, currentLang }: VideoTestimonialsProps) {
  ...
  const testimonials: VideoTestimonial[] = [
    {
      id: 1,
      name: "Sami Al Khalili",
      nameAr: "سامي الخليلي",
      title: "CTO",
      titleAr: "الرئيس التنفيذي",
      company: "affinity Group",
      companyAr: "affinity Group",
      videoUrl: "/business-woman-testimonial.jpg",
      thumbnail: "/confident-businesswoman.png",
      quote: "affinity Technology transformed our entire digital infrastructure. ROI increased by 300%.",
      quoteAr: "غيّرت affinity Technology بنيتنا الرقمية بالكامل. زاد العائد على الاستثمار بنسبة 82.",
      rating: 5,
      industry: "Digital Marketing Agency",
      industryAr: "وكالة التسويق الرقمي",
    },
    {
      id: 2,
